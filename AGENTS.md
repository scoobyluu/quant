...
- `portfolio.csv` uses `ticker,quantity,cost`, with optional `account,asset_class,sector,acquired`. It is user-owned import data; read it but do not rewrite it. SQLite is the dashboard source of truth after first import.
